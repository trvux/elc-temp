    ...
    <main className="w-full bg-background min-h-screen flex flex-col">
      ...
      <div id="project-detail-content" className="w-full relative">
        ...
        {/* Body copy stays at max-w-2xl (672px, closest Tailwind step to
            ...
            to widen fluidly — matching Linear's own h1, which is NOT
            stepped: width = min(900px, 100% - 3rem) at every viewport from
            500px to 1920px (dense sweep, ~20 widths), never jumping the way
            a sm:/md:/lg: breakpoint would. A single max-w-[Nrem] (no
            breakpoint variants) reproduces that fluid-then-capped curve
            here, since this wrapper already sits inside sectionContainer's
            own padding, so "100%" is already viewport-relative.
        ...
        <div className="max-w-[56.25rem] mx-auto flex flex-col gap-6 animate-fade-in-up">
          {/* Title */}
          <TypographyH1
            className={cn(
