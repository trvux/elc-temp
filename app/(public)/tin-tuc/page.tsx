    ...
    <main className={STYLES.main}>
      <div className={STYLES.container}>
        <header className={STYLES.header}>
          <TypographyH1 className={STYLES.title}>Tin tức & Dịch vụ</TypographyH1>
          <TypographyLead className={STYLES.description}>
            Cập nhật những giải pháp kỹ thuật mới nhất và các gói dịch vụ bảo trì chuyên sâu từ đội ngũ kỹ sư ELC.
          </TypographyLead>
        </header>
