    ...
    <main className="w-full bg-background min-h-screen flex flex-col">
      ...
      <div id="branch-detail-content" className="w-full relative">
        ...
        {/* Body copy stays at max-w-2xl (672px, closest Tailwind step to
            ...
            same 43-char test title, a ~9% gap from font metrics, not a CSS
            bug). Self-hosting Linear's exact font build was considered and
            declined (2026-09-24) — 1000px gives enough headroom to fit
            real titles at the ~9% gap without over-widening. Body text's
