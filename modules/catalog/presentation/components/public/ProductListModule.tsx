...
// category/group entities: brand names essentially never appear verbatim in
// article titles, so we don't bother fetching for those.
...
function getFallbackContent(entity: ResolvedEntity) {
  ...
  if (entity.type === "category") {
    ...
    p1 = `Danh mục ${name} tại Điện máy ELC tập hợp đa dạng các dòng sản phẩm làm mát từ phân khúc dân dụng đến thương mại, phục vụ mọi nhu cầu sử dụng của hộ gia đình, văn phòng và các dự án công trình quy mô lớn. Chúng tôi luôn cập nhật những dòng máy mới nhất tích hợp công nghệ làm lạnh nhanh, công nghệ biến tần tiết kiệm điện năng và hệ thống lọc khí hiện đại giúp bảo vệ sức khỏe tối đa cho các member trong gia đình.`;
    p2 = `Để sở hữu hệ thống ${name.toLowerCase()} hoạt động hiệu quả và bền bỉ, việc khảo sát thiết kế và lắp đặt đúng tiêu chuẩn kỹ thuật đóng vai trò cực kỳ quan trọng. Đến với Điện máy ELC, quý khách hàng không chỉ nhận được sản phẩm chính hãng 100% với giá tốt nhất mà còn được trải nghiệm dịch vụ thi công trọn gói chuyên nghiệp, chuyên sâu từ khâu đi đường ống đến vận hành chạy thử hệ thống, cam kết mang lại sự hài lòng tuyệt đối.`;
  }
  ...
  if (entity.type === "category") {
    ...
    return [
      ...
      },
      {
        ...
        answer: `Đúng vậy, Điện máy ELC là đối tác phân phối chính thức của thương hiệu này, cam kết cung cấp sản phẩm chính hãng chất lượng cao cùng mức giá cực kỳ ưu đãi.`,
      },
      {
