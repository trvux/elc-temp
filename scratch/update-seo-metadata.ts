...
async function run() {
  ...
  const { error: catError } = await supabase
    ...
    .update({
      ...
      meta_description: "Mua máy lạnh treo tường (điều hòa treo tường) chính hãng Daikin, Panasonic, LG... giá rẻ tại kho. Cam kết hàng mới 100%, bảo hành uy tín, hỗ trợ lắp đặt chuyên nghiệp."
    })
  ...
  const { error: groupError } = await supabase
    ...
    .update({
      meta_title: "Tổng Kho Máy Lạnh Chính Hãng, Giá Rẻ Tại Kho",
      meta_description: "Nhà thầu phân phối máy lạnh chính hãng Daikin, Panasonic, LG... giá tốt nhất. Hỗ trợ khảo sát, thiết kế, thi công lắp đặt và bảo hành uy tín tận nơi."
    })
