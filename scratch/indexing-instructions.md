...
- Remaining URLs in `scratch/urls-to-index.txt` to index on next run: 211

## TODO
- [ ] Run indexing tomorrow (2026-06-30): `npx tsx scratch/indexing-api.ts` — 211 URLs remaining.
